function toggleMobileMenu(menu) {
    var element = document.getElementById("menubox");
...
const filterItem = document.querySelector(".navGaleria");
const filterImg = document.querySelectorAll(".Gallery_img .image");
  ...
  filterItem.onclick = (selectedItem)=>{ //if user click on filterItem div
    if(selectedItem.target.classList.contains("list")){ //if user selected item has .item class
      ...
      filterImg.forEach((image) => {
        ...
        if((filterImges == filterName) || (filterName == "Wszystkie")){
